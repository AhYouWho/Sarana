    ...
    (t = {
      ...
      764: (t, e, n) => {
        ...
        function d(t, e, n, r, o) {
          ...
          if (("string" == typeof e && (e = a.from(e, r)), a.isBuffer(e)))
            return 0 === e.length ? -1 : T(t, e, n, r, o);
          if ("number" == typeof e)
            return (
              (e &= 255),
        ...
        (a.TYPED_ARRAY_SUPPORT = (function () {
          ...
          (a.concat = function (t, e) {
            ...
            for (n = 0; n < t.length; ++n) {
              ...
              if (z(e, Uint8Array))
                o + e.length > r.length
                  ? (a.isBuffer(e) || (e = a.from(e)), e.copy(r, o))
        ...
        (a.prototype.slice = function (t, e) {
          ...
          (a.prototype.readBigUInt64LE = Z(function (t) {
            ...
            const e = this[t],
              n = this[t + 7];
            (void 0 !== e && void 0 !== n) || K(t, this.length - 8);
            const r =
        ...
        function K(t, e, n) {
          if (Math.floor(t) !== t)
            throw (
              (Q(t, n), new k.ERR_OUT_OF_RANGE(n || "offset", "an integer", t))
            );
              ...
              e = Math.abs(e),
                isNaN(e) || e === 1 / 0
                  ...
                  : ((s = Math.floor(Math.log(e) / Math.LN2)),
                    ...
                    (e += s + f >= 1 ? h / a : h * Math.pow(2, 1 - f)) * a >=
                      2 && (s++, (a /= 2)),
                    s + f >= l
                      ? ((u = 0), (s = l))
                      : s + f >= 1
                      ? ((u = (e * a - 1) * Math.pow(2, o)), (s += f))
                      : ((u = e * Math.pow(2, f - 1) * Math.pow(2, o)),
                        (s = 0)));
              o >= 8;
              t[n + p] = 255 & u, p += g, u /= 256, o -= 8
            );
            for (
              s = (s << o) | u, c += o;
              c > 0;
      ...
      568: (t, e, n) => {
        ...
        (r = n(12)),
          ...
          ((u = function (t, e) {
            ...
            for (p = 0; p < n.length; p += 16) {
              ...
              (c = g(c, l, f, h, n[p + 0], 7, -680876936)),
                ...
                (c = I(
                  c,
                  (l = g(l, f, h, c, n[p + 15], 22, 1236535329)),
                  f,
                  h,
                  n[p + 1],
                  5,
                ...
                (h = I(h, c, l, f, n[p + 6], 9, -1069501632)),
                (f = I(f, h, c, l, n[p + 11], 14, 643717713)),
                (l = I(l, f, h, c, n[p + 0], 20, -373897302)),
                (c = I(c, l, f, h, n[p + 5], 5, -701558691)),
                (h = I(h, c, l, f, n[p + 10], 9, 38016083)),
                (f = I(f, h, c, l, n[p + 15], 14, -660478335)),
                (l = I(l, f, h, c, n[p + 4], 20, -405537848)),
                (c = I(c, l, f, h, n[p + 9], 5, 568446438)),
                (h = I(h, c, l, f, n[p + 14], 9, -1019803690)),
                (f = I(f, h, c, l, n[p + 3], 14, -187363961)),
                (l = I(l, f, h, c, n[p + 8], 20, 1163531501)),
                (c = I(c, l, f, h, n[p + 13], 5, -1444681467)),
                (h = I(h, c, l, f, n[p + 2], 9, -51403784)),
                (f = I(f, h, c, l, n[p + 7], 14, 1735328473)),
                (c = A(
                  c,
                  (l = I(l, f, h, c, n[p + 12], 20, -1926607734)),
                  f,
                  h,
                  n[p + 5],
                  4,
                ...
                (h = A(h, c, l, f, n[p + 8], 11, -2022574463)),
                (f = A(f, h, c, l, n[p + 11], 16, 1839030562)),
                (l = A(l, f, h, c, n[p + 14], 23, -35309556)),
                (c = A(c, l, f, h, n[p + 1], 4, -1530992060)),
                (h = A(h, c, l, f, n[p + 4], 11, 1272893353)),
                (f = A(f, h, c, l, n[p + 7], 16, -155497632)),
                (l = A(l, f, h, c, n[p + 10], 23, -1094730640)),
                (c = A(c, l, f, h, n[p + 13], 4, 681279174)),
                (h = A(h, c, l, f, n[p + 0], 11, -358537222)),
                (f = A(f, h, c, l, n[p + 3], 16, -722521979)),
                (l = A(l, f, h, c, n[p + 6], 23, 76029189)),
                (c = A(c, l, f, h, n[p + 9], 4, -640364487)),
                (h = A(h, c, l, f, n[p + 12], 11, -421815835)),
                (f = A(f, h, c, l, n[p + 15], 16, 530742520)),
                (c = N(
                  c,
                  (l = A(l, f, h, c, n[p + 2], 23, -995338651)),
                  f,
                  h,
                  n[p + 0],
                  6,
          ...
          (u._gg = function (t, e, n, r, o, i, s) {
            var u = t + ((e & r) | (n & ~r)) + (o >>> 0) + s;
            return ((u << i) | (u >>> (32 - i))) + e;
          }),
          (u._hh = function (t, e, n, r, o, i, s) {
            var u = t + (e ^ n ^ r) + (o >>> 0) + s;
            return ((u << i) | (u >>> (32 - i))) + e;
          }),
          (u._ii = function (t, e, n, r, o, i, s) {
            var u = t + (n ^ (e | ~r)) + (o >>> 0) + s;
            return ((u << i) | (u >>> (32 - i))) + e;
          }),
          (u._blocksize = 16),
      ...
      865: (t, e, n) => {
        const { errorCode: r } = n(466),
          { KHQRResponse: o } = n(123),
          i = n(670);
      ...
      775: (t, e, n) => {
        const { emv: r, errorCode: o } = n(466),
          { KHQRResponse: i } = n(123),
          s = n(670);
        class u extends s {
          constructor(t, e) {
        ...
        class c extends s {
          constructor(t, e) {
            if (e.length > r.INVALID_LENGTH.TERMINAL_LABEL || "" == e)
        ...
        class l extends s {
          constructor(t, e) {
            if (e.length > r.INVALID_LENGTH.MOBILE_NUMBER || "" == e)
        ...
        t.exports = class extends s {
          constructor(t, e) {
            ...
            let f,
              ...
              I = "";
            null != n &&
              ((f = new u(r.BILLNUMBER_TAG, n)), (I += f.toString())),
              null != o &&
                ((h = new l(r.ADDITIONAL_DATA_FIELD_MOBILE_NUMBER, o)),
                (I += h.toString())),
              null != i &&
                ((p = new a(r.STORELABEL_TAG, i)), (I += p.toString())),
              null != s &&
                ((g = new c(r.TERMINAL_TAG, s)), (I += g.toString())),
              super(t, I),
              (this.billNumber = f),
              (this.mobileNumber = h),
              (this.storeLabel = p),
              (this.terminalLabel = g),
              (this.data = {
                billNumber: f,
                mobileNumber: h,
                storeLabel: p,
      ...
      689: (t, e, n) => {
        const r = n(670),
          { emv: o, errorCode: i } = n(466),
          { KHQRResponse: s } = n(123);
        class u extends r {
          constructor(t, e) {
            if ("" == e || null == e || null == e)
        ...
        t.exports = class extends r {
          constructor(t, e) {
            ...
            const n = e.bakongAccountID,
              ...
              g = new u(o.BAKONG_ACCOUNT_IDENTIFIER, n);
            let I = g.toString();
            if (h) {
              ...
              null != p &&
                (I += new a(o.INDIVIDUAL_ACCOUNT_INFORMATION, p).toString()),
                null != f &&
                  (I += new l(
                ...
                (this.data = { bakongAccountID: g, accountInformation: p });
      ...
      575: (t, e, n) => {
        ...
        t.exports = class extends s {
          constructor(t, e) {
            if ("" == e || null == e || null == e)
              throw i(null, o.PAYLOAD_FORMAT_INDICATOR_TAG_REQUIRED);
            if (e.length > 2)
              throw i(null, o.PAYLOAD_FORMAT_INDICATOR_LENGTH_INVALID);
            super(t, e);
          }
        };
      },
      ...
      453: (t, e, n) => {
        const { emv: r, errorCode: o, khqrData: i } = n(466),
          { KHQRResponse: s } = n(123),
          u = n(670);
        t.exports = class extends u {
          constructor(t, e) {
            ...
            if (e.length > 3)
              throw s(null, o.TRANSACTION_CURRENCY_LENGTH_INVALID);
            if (![i.currency.khr, i.currency.usd].includes(parseInt(e)))
      ...
      710: (t, e, n) => {
        ...
        t.exports = [
          ...
          { tag: "53", type: "transactionCurrency", required: !0, instance: i },
          { tag: "54", type: "transactionAmount", required: !1, instance: c },
          { tag: "58", type: "countryCode", required: !0, instance: u },
          { tag: "59", type: "merchantName", required: !0, instance: l },
          { tag: "60", type: "merchantCity", required: !0, instance: a },
          {
            tag: "62",
            sub: !0,
            type: "additionalData",
      ...
      8: (t) => {
        t.exports = {
          ...
          merchantType: { merchant: "merchant", individual: "individual" },
        };
      },
      270: (t, e, n) => {
        const { errorCode: r } = n(466),
        ...
        t.exports = function (t) {
          ...
          for (; t; ) {
            ...
            if (n == f) break;
            "30" == n ? ((l = "30"), (n = "29")) : "29" == n && (l = "29"),
              e.includes(n) && ((c[n] = o), (r = r.filter((t) => t != n))),
              (t = i),
              (f = n);
          }
          let h = { merchantType: l };
          return (
            u.map((t) => t.data).forEach((t) => (h = { ...h, ...t })),
            i.forEach((t) => {
              const e = t.tag,
                r = i.find((t) => t.tag == e);
              let o = null == c[e] ? null : c[e],
                l = o;
              if (n.includes(e)) {
                const t = ((t, e) => t.find((t) => t.tag == e))(u, e).data;
                for (; o; ) {
                  cutsubstring = s(o);
                ...
                (h[r.type] = o), "99" == e && null == o && (h[r.type] = null);
            }),
            h
          );
        };
      ...
      262: (t, e, n) => {
        const { errorCode: r } = n(466),
          ...
          s = n(215),
          { KHQRResponse: u } = n(123),
          a = (t, e) => t.find((t) => t.tag == e);
        t.exports = function (t) {
          const e = i.map((t) => t.tag),
            n = i.filter((t) => 1 == t.sub).map((t) => t.tag);
          let c = i.filter((t) => 1 == t.required).map((t) => t.tag);
          const l = o.input,
            f = o.compare;
          let h = [],
            p = "individual",
          ...
          for (; t; ) {
            ...
            if (n == g) break;
            "30" == n && ((p = "merchant"), (n = "29")),
              e.includes(n) &&
                (h.push({ tag: n, value: r }), (c = c.filter((t) => t != n))),
              (t = o),
              (g = n);
          }
          if (0 != c.length) {
            const t = c[0];
            new (0, a(i, t).instance)(t, null);
          }
          if (
            !(I = h.map((t) => parseInt(t.tag)).splice(-1, 1))
              .slice(1)
              .every((t, e) => t > I[e])
          )
            throw u(null, r.TAG_NOT_IN_ORDER);
          var I;
          let A = { merchantType: p };
          return (
            l.map((t) => t.data).forEach((t) => (A = { ...A, ...t })),
            h.forEach((t) => {
              const e = t.tag,
                r = i.find((t) => t.tag == e);
              let o = t.value,
              ...
              if (n.includes(e)) {
                ...
                for (; o; ) {
                  ...
                  let a = f
                    .filter((t) => t.tag == e)
                    .find((t) => t.subTag == n);
                  null != a && ((a = a.name), (t[a] = r), (u = t)), (o = i);
                }
                (A = { ...A, ...u }), new r.instance(e, u);
              } else {
                const t = new r.instance(e, u);
                A[r.type] = t.value;
              }
            }),
            A
      ...
      399: (t, e, n) => {
        const { emv: r, khqrData: o, errorCode: i } = n(466),
          s = n(967),
          {
            PointOfInitiationMethod: u,
            PayloadFormatIndicator: a,
        ...
        t.exports = function (t, e) {
          ...
          try {
            ...
            let y = r.DYNAMIC_QR;
            (null != _ && 0 != _) || (y = r.STATIC_QR);
            const R = new u(r.POINT_OF_INITIATION_METHOD, y);
            let C = r.MERCHANT_ACCOUNT_INFORMATION_INDIVIDUAL;
            "merchant" == e && (C = r.MERCHANT_ACCOUNT_INFORMATION_MERCHANT);
            const m = new c(C, n),
              b = [
                E,
                R,
                ...
                new l(r.TRANSACTION_CURRENCY, t.currency),
              ];
            if (null != _ && 0 != _) {
              let e = t.amount;
              if (t.currency == o.currency.khr) {
                if (e % 1 != 0) throw d(null, i.TRANSACTION_AMOUNT_INVALID);
                e = Math.round(e);
              } else {
                const t = String(e).split(".")[1];
                if (null != t && t.length > 2)
                  throw d(null, i.TRANSACTION_AMOUNT_INVALID);
                null != t && (e = parseFloat(e).toFixed(2));
              }
              const n = new g(r.TRANSACTION_AMOUNT, e);
              b.push(n);
            }
            const O = new f(r.COUNTRY_CODE, r.DEFAULT_COUNTRY_CODE);
            b.push(O);
            const L = new I(r.MERCHANT_NAME, t.merchantName);
            b.push(L);
            const w = new h(r.MERCHANT_CITY, t.merchantCity);
            let D;
            b.push(w),
              Object.values(T).every(
                (t) => null == t || null == t || "" == t
              ) || ((D = new N(r.ADDITIONAL_DATA_TAG, T)), b.push(D));
            const B = new A(r.TIMESTAMP_TAG);
            b.push(B);
            let U = "";
            for (let t = 0; t < b.length; t++) U += b[t].toString();
            return (khqr = U + r.CRC + r.CRC_LENGTH), (khqr += s(khqr)), khqr;
          } catch (t) {
            return t;
          }
        };
      ...
      194: (t, e, n) => {
        const { KHQRResponse: r } = n(123),
          { errorCode: o, emv: i } = n(466),
          s = n(300);
        t.exports = async function (t, e) {
          ...
          try {
            n = await s(t, {
              ...
              body: JSON.stringify({ accountId: e }),
              timeout: 45e3,
            });
            const r = n.clone();
          ...
          if (null == n) throw r(null, o.CONNECTION_TIMEOUT);
          if (404 == n.status || 500 == n.status)
            throw r(null, o.CONNECTION_TIMEOUT);
          const u = await n.json();
          if (404 == u.status || 500 == u.status)
            throw r(null, o.CONNECTION_TIMEOUT);
          const a = u.responseCode,
            c = u.errorCode;
          if (11 == c) return { bakongAccountExisted: !1 };
          if (12 == c) throw r(null, o.BAKONG_ACCOUNT_ID_INVALID);
          return 0 == a
      ...
      967: (t, e, n) => {
        ...
        t.exports = function (t) {
          ...
          for (t = r.from(t), n = 0; n < t.length; n++)
            (c = t[n]), (e = 255 & (c ^ (i >> 8))), (i = o[e] ^ (i << 8));
          return (function (t) {
            let e = t.toString(16).toUpperCase();
            e.length < 4 && (e = "0" * (4 - e.length) + e);
            const n = 4 - e.length;
            return e.length < 4 && (e = "0" * n + e), e;
          })(65535 & (0 ^ i));
        };
      },
      215: (t) => {
      ...
      914: (t, e, n) => {
        ...
        t.exports = {
          isValidLink: function (t) {
            try {
              if ("/v1/generate_deeplink_by_qr" != new URL(t).pathname)
                return !1;
            } catch (t) {
              return !1;
            }
      ...
      138: (t, e, n) => {
        const { khqrData: r, errorCode: o, emv: i } = n(466),
          s = n(967),
          u = n(134),
          { isValidLink: a, callDeepLinkAPI: c, SourceInfo: l } = n(914),
          { KHQRDeepLinkData: f, KHQRResponse: h } = n(123),
          { IndividualInfo: p, MerchantInfo: g } = n(648),
          I = n(399),
          A = n(270),
          N = n(568),
          d = n(262),
        ...
        t.exports = {
          BakongKHQR: class {
            generateIndividual(t) {
              const e = I(t, r.merchantType.individual);
              if (null != e.status) return e;
              const n = { qr: e, md5: N(e) };
              return h(n, null);
            }
            generateMerchant(t) {
              const e = I(t, r.merchantType.merchant);
              if (null != e.status) return e;
              const n = { qr: e, md5: N(e) };
              return h(n, null);
            }
            ...
            static verify(t) {
              const e = t.slice(-4),
                ...
                a = new u(r);
              try {
                if (!a.isValid || t.length < i.INVALID_LENGTH.KHQR)
            ...
            static async generateDeepLink(t, e, n) {
              if (!a(t)) return h(null, o.INVALID_DEEP_LINK_URL);
              if (!this.verify(e).isValid) return h(null, o.KHQR_INVALID);
              if (n && (!n.appIconUrl || !n.appName || !n.appDeepLinkCallback))
                return h(null, o.INVALID_DEEP_LINK_SOURCE_INFO);
              let r;
              try {
                if (
                  ((r = await c(t, { qr: e })),
                  404 == r.status || 500 == r.status)
                )
                  return h(null, o.CONNECTION_TIMEOUT);
                const n = await r.json();
                if (5 == n.errorCode)
                  return h(null, o.INVALID_DEEP_LINK_SOURCE_INFO);
                if (4 == n.errorCode) return h(null, o.INTERNAL_SERVER_ERROR);
                const i = new f(n.data.shortLink);
                return h(i.getData(), null);
              } catch (t) {
                return t;
              }
            }
      ...
      648: (t, e, n) => {
        const { khqrData: r } = n(466);
        class o {
          constructor(t, e, n, o = {}) {
            if (this.isObject(t) || this.isObject(e) || this.isObject(n))
              throw "bakongAccountID, merchantName or merchantCity must be a string";
            (this.bakongAccountID = t),
              (this.accountInformation = o.accountInformation),
              (this.acquiringBank = o.acquiringBank),
              (this.currency =
                null == o.currency ? r.currency.khr : o.currency),
              (this.amount = o.amount),
              (this.merchantName = e),
              (this.merchantCity = n),
              (this.billNumber = o.billNumber),
              (this.storeLabel = o.storeLabel),
              (this.terminalLabel = o.terminalLabel),
              (this.mobileNumber = o.mobileNumber);
          }
          isObject(t) {
        ...
        t.exports = {
          IndividualInfo: o,
          MerchantInfo: class extends o {
            constructor(t, e, n, r, o, i = {}) {
              if ((super(t, e, n, i), this.isObject(r) || this.isObject(o)))
                throw "merchantID and acquiringBank must be a string";
              (this.amount = i.amount),
                (this.merchantID = r),
                (this.acquiringBank = o);
            }
            isObject(t) {
              return t instanceof Object;
            }
